...
import (
	...
	"github.com/everFinance/go-everpay/token/schema"
	"strconv"
)
...
func InitToken(everChainId int, ethRpcUrl, moonRpcUrl, cfxRpcUrl, arNodeUrl, pstGwUrl string) (tokens map[string]*token.Token) {
	// lockers
	...
	case everMainChainId:
		...
		ar := token.New(
			...
			"AR", schema.ChainTypeCrossArEth, fmt.Sprintf("%s,%s", arweaveMainChainId, ethMainChainId), 12,
			[]schema.TargetChain{
				{
		...
		vrt := token.New(
			"usjm4PCxUd5mtaon7zc97-dt-3qf67yPyqgzLnLqk5A", "VRT", schema.ChainTypeArweave, arweaveMainChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   arweaveMainChainId,
					ChainType: schema.OracleArweaveChainType,
		...
		ardrive := token.New(
			"-8A6RexFkpfWwuyVO98wzSFZh0d6VJuI-buTJvlwOJQ", "ARDRIVE", schema.ChainTypeArweave, arweaveMainChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   arweaveMainChainId,
					ChainType: schema.OracleArweaveChainType,
		...
		wbtc := token.New(
			"0x2260fac5e5542a773aa44fbcfedf7c193bc2c599", "WBTC", schema.ChainTypeEth, ethMainChainId, 8,
			[]schema.TargetChain{
				{
					ChainId:   ethMainChainId,
					ChainType: schema.OracleEthChainType,
		...
		usdt := token.New(
			"0xdac17f958d2ee523a2206206994597c13d831ec7", "USDT", schema.ChainTypeEth, ethMainChainId, 6,
			[]schema.TargetChain{
				{
					ChainId:   ethMainChainId,
					ChainType: schema.OracleEthChainType,
		...
		usdc := token.New(
			"0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48", "USDC", schema.ChainTypeEth, ethMainChainId, 6,
			[]schema.TargetChain{
				{
					ChainId:   ethMainChainId,
					ChainType: schema.OracleEthChainType,
		...
		dai := token.New(
			"0x6b175474e89094c44da98b954eedeac495271d0f", "DAI", schema.ChainTypeEth, ethMainChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   ethMainChainId,
					ChainType: schema.OracleEthChainType,
		...
		uni := token.New(
			"0x1f9840a85d5af5bf1d1762f925bdaddc4201f984", "UNI", schema.ChainTypeEth, ethMainChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   ethMainChainId,
					ChainType: schema.OracleEthChainType,
		...
		sos := token.New(
			"0x3b484b82567a09e2588a13d54d032153f0c0aee0", "SOS", schema.ChainTypeEth, ethMainChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   ethMainChainId,
					ChainType: schema.OracleEthChainType,
		...
		bank := token.New(
			"0x2d94aa3e47d9d5024503ca8491fce9a2fb4da198", "BANK", schema.ChainTypeEth, ethMainChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   ethMainChainId,
					ChainType: schema.OracleEthChainType,
		...
		dodo := token.New(
			"0x43dfc4159d86f3a37a5a4b3d4580b888ad7d4ddd", "DODO", schema.ChainTypeEth, ethMainChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   ethMainChainId,
					ChainType: schema.OracleEthChainType,
		...
		mask := token.New(
			"0x69af81e73a73b40adf4f3d4223cd9b1ece623074", "MASK", schema.ChainTypeEth, ethMainChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   ethMainChainId,
					ChainType: schema.OracleEthChainType,
		...
		t4ever := token.New(
			"0xeaba187306335dd773ca8042b3792c46e213636a", "T4EVER", schema.ChainTypeEth, ethMainChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   ethMainChainId,
					ChainType: schema.OracleEthChainType,
		...
		tokenList = append(tokenList, eth, usdc, usdt, wbtc, dai, uni, sos, bank, dodo, mask, t4ever)

		// moonbeam tokens
		glmr := token.New(
			schema.MoonAddress, "GLMR", schema.ChainTypeMoonbeam, moonMainChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   moonMainChainId,
					ChainType: schema.OracleMoonChainType,
		...
		zlk := token.New(
			"0x3fd9b6c9a24e09f67b7b706d72864aebb439100c", "ZLK", schema.ChainTypeMoonbeam, moonMainChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   moonMainChainId,
					ChainType: schema.OracleMoonChainType,
	...
	case everDevChainId:
		...
		ar := token.New(
			...
			"AR", schema.ChainTypeCrossArEth, fmt.Sprintf("%s,%s", arweaveMainChainId, ethKovanChainId), 12,
			[]schema.TargetChain{
		...
		vrt := token.New(
			"usjm4PCxUd5mtaon7zc97-dt-3qf67yPyqgzLnLqk5A", "VRT", schema.ChainTypeArweave, arweaveDevChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   arweaveMainChainId,
					ChainType: schema.OracleArweaveChainType,
		...
		ardrive := token.New(
			"-8A6RexFkpfWwuyVO98wzSFZh0d6VJuI-buTJvlwOJQ", "ARDRIVE", schema.ChainTypeArweave, arweaveDevChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   arweaveMainChainId,
					ChainType: schema.OracleArweaveChainType,
		...
		xyz := token.New(
			"mzvUgNc8YFk0w5K5H7c8pyT-FC5Y_ba0r7_8766Kx74", "XYZ", schema.ChainTypeArweave, arweaveDevChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   arweaveMainChainId,
					ChainType: schema.OracleArweaveChainType,
		...
		pia := token.New(
			"n05LTiuWcAYjizXAu-ghegaWjL89anZ6VdvuHcU6dno", "PIA", schema.ChainTypeArweave, arweaveDevChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   arweaveMainChainId,
					ChainType: schema.OracleArweaveChainType,
		...
		usdt := token.New(
			"0xd85476c906b5301e8e9eb58d174a6f96b9dfc5ee", "USDT", schema.ChainTypeEth, ethKovanChainId, 6,
			[]schema.TargetChain{
				{
					ChainId:   ethKovanChainId,
					ChainType: schema.OracleEthChainType,
		...
		usdc := token.New(
			"0xb7a4f3e9097c08da09517b5ab877f7a917224ede", "USDC", schema.ChainTypeEth, ethKovanChainId, 6,
			[]schema.TargetChain{
				{
					ChainId:   ethKovanChainId,
					ChainType: schema.OracleEthChainType,
		...
		dai := token.New(
			"0xc4375b7de8af5a38a93548eb8453a498222c4ff2", "DAI", schema.ChainTypeEth, ethKovanChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   ethKovanChainId,
					ChainType: schema.OracleEthChainType,
		...
		// moonbase tokens
		glmr := token.New(
			schema.MoonAddress, "DEV", schema.ChainTypeMoonbase, moonDevChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   moonDevChainId,
					ChainType: schema.OracleMoonChainType,
		...
		zlk := token.New(
			"0x322f069e9b8b554f3fb43cefcb0c7b3222242f0e", "ZLK", schema.ChainTypeMoonbase, moonDevChainId, 18,
			[]schema.TargetChain{
				{
					ChainId:   moonDevChainId,
					ChainType: schema.OracleMoonChainType,
